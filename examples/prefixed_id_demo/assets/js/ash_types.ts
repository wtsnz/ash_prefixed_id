...
export type ProjectResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "insertedAt" | "updatedAt" | "teamId";
  id: string;
  name: string;
  insertedAt: UtcDateTimeUsec;
  updatedAt: UtcDateTimeUsec;
  teamId: string;
  team: { __type: "Relationship"; __resource: TeamResourceSchema; };
...
// Team Schema
export type TeamResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "insertedAt" | "updatedAt";
  id: string;
  name: string;
  insertedAt: UtcDateTimeUsec;
  updatedAt: UtcDateTimeUsec;
  projects: { __type: "Relationship"; __array: true; __resource: ProjectResourceSchema; };
};



export type TeamAttributesOnlySchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "insertedAt" | "updatedAt";
  id: string;
  name: string;
...
export type TeamFilterInput = {
  and?: Array<TeamFilterInput>;
  or?: Array<TeamFilterInput>;
  not?: Array<TeamFilterInput>;
...
export const projectFilterFields = ["id", "name", "insertedAt", "updatedAt", "teamId", "team", "todos"] as const;
export type ProjectFilterField = (typeof projectFilterFields)[number];

export const teamFilterFields = ["id", "name", "insertedAt", "updatedAt", "projects"] as const;
export type TeamFilterField = (typeof teamFilterFields)[number];

export const todoFilterFields = ["id", "title", "done", "insertedAt", "updatedAt", "projectId", "project"] as const;
export type TodoFilterField = (typeof todoFilterFields)[number];


export const projectSortFields = ["id", "name", "insertedAt", "updatedAt", "teamId"] as const;
export type ProjectSortField = (typeof projectSortFields)[number];

export const teamSortFields = ["id", "name", "insertedAt", "updatedAt"] as const;
export type TeamSortField = (typeof teamSortFields)[number];

export const todoSortFields = ["id", "title", "done", "insertedAt", "updatedAt", "projectId"] as const;
